...
export const translations: Record<Language, TranslationTree> = {
  da: {
    ...
    admin: {
      ...
      totpHeading: 'To-faktor-godkendelse (2FA)',
      totpIntro: 'Beskytter admin-login med en engangskode fra en autenticator-app (fx Google Authenticator eller Authy), ud over adgangskoden.',
      totpStatusOff: '2FA er slået FRA',
      totpStatusOn: '2FA er slået TIL',
      totpEnableBtn: 'Slå 2FA til',
      totpDisableBtn: 'Slå 2FA fra',
      totpDisableConfirm: 'Slå 2FA fra? Du kan altid slå det til igen senere.',
      totpScanInstructions: 'Scan QR-koden med din autenticator-app, eller indtast koden manuelt.',
      totpManualSecret: 'Manuel kode:',
      totpCodeLabel: '6-cifret kode fra appen',
      totpConfirmBtn: 'Bekræft og slå til',
      totpStartError: 'Kunne ikke starte opsætning af 2FA. Prøv igen.',
      totpInvalidCode: 'Forkert kode. Tjek din autenticator-app og prøv igen.',
  ...
  en: {
    ...
    admin: {
      ...
      totpHeading: 'Two-factor authentication (2FA)',
      totpIntro: 'Protects admin login with a one-time code from an authenticator app (e.g. Google Authenticator or Authy), in addition to the password.',
      totpStatusOff: '2FA is OFF',
      totpStatusOn: '2FA is ON',
      totpEnableBtn: 'Turn on 2FA',
      totpDisableBtn: 'Turn off 2FA',
      totpDisableConfirm: 'Turn off 2FA? You can always turn it back on later.',
      totpScanInstructions: 'Scan the QR code with your authenticator app, or enter the code manually.',
      totpManualSecret: 'Manual code:',
      totpCodeLabel: '6-digit code from the app',
      totpConfirmBtn: 'Confirm and turn on',
      totpStartError: 'Could not start 2FA setup. Please try again.',
      totpInvalidCode: 'Wrong code. Check your authenticator app and try again.',
  ...
  tl: {
    ...
    admin: {
      ...
      totpHeading: 'Two-factor authentication (2FA)',
      totpIntro: 'Nagprotekta sa admin login gamit ang one-time code mula sa isang authenticator app (hal. Google Authenticator o Authy), bukod sa password.',
      totpStatusOff: 'Naka-OFF ang 2FA',
      totpStatusOn: 'Naka-ON ang 2FA',
      totpEnableBtn: 'I-on ang 2FA',
      totpDisableBtn: 'I-off ang 2FA',
      totpDisableConfirm: 'I-off ang 2FA? Puwede mo pa rin itong i-on ulit anumang oras.',
      totpScanInstructions: 'I-scan ang QR code gamit ang authenticator app mo, o i-type ang code nang manu-mano.',
      totpManualSecret: 'Manual na code:',
      totpCodeLabel: '6-digit na code mula sa app',
      totpConfirmBtn: 'Kumpirmahin at i-on',
      totpStartError: 'Hindi ma-set up ang 2FA. Subukan ulit.',
      totpInvalidCode: 'Maling code. Tingnan ang authenticator app mo at subukan ulit.',
